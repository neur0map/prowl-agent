...
const expectedPromptHash = "527295afdee2712d917d08220b7a68030c6b21db646721c17b2060076313c3ca"
...
func testSnapshot(t *testing.T) *profile.Snapshot {
	...
	input := profile.SnapshotInput{
		...
		Sources: []profile.SourceInput{
			...
			{ID: "project:AGENTS.md", Kind: profile.ProjectInstructionSource, Body: "Run focused tests.", Provenance: profile.RootedProjectProvenance, Scope: profile.WorkspaceScope, Included: true, Reason: "rooted", IsRooted: true},
